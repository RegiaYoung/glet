...
void bootProxy(int devid, int cap, int dedup_num, int part_index, int ngpu, int nparts, string PROXY_DIR, string PROXY_SH, const char* MODEL_LIST){
        pid_t pid = 0;
        int   status;
        string proxy_sh = PROXY_DIR+"/"+PROXY_SH;
...
pthread_t bootProxyThread(proxy_info* pPInfo, int ngpu, int nparts, string proxy_full_dir, string proxy_sh){
    pthread_attr_t attr;
...
void ProxyCtrl::setProxyConstants(string proxy_full_dir, string proxy_sh){
