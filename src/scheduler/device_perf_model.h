...
class DevPerfModel{
	public:
		...
		float getInterference(std::string my_model, int my_batch, int my_partition, string your_model, int your_batch, int your_partition);
		int getDevMem();
	private:
		int _dev_mem;
		interference_modeling::interference_model _IntModel;
